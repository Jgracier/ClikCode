...
import { localHarnessCapabilityManifest, localHarnessForCommand, localHarnessForProvider, compactPath, sessionProviderLabel } from './native-harness-protocol.js';
import { readState, writeState } from './harness-state.js';
import { nativeModelCatalog, nativeUsageReading, usageResetLabel } from './native-account-data.js';
...
import { aiGatewaySessionSend } from './ai-turn.js';
...
import { routeSlashInput, slashPalette, unknownSlashMessage, type SlashHandlerKey } from './slash-registry.js';
