...
import { accountView, deviceManifest, harnessCommand, harnessStatePath, readState, writeState } from './harness-state.js';
import { streamLocalAiTurn } from './native-harness-protocol.js';
