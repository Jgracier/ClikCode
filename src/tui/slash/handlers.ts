...
import { harnessSupportsPermissionMode, localHarnessCapabilityManifest, localHarnessForCommand, localHarnessForProvider, compactPath, sessionProviderLabel } from '../../harness/transport/native-protocol.js';
