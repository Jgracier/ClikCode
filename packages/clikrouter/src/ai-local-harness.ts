...
export const AI_LOCAL_HARNESSES: readonly AiLocalHarnessDefinition[] = [
  ...
  { ...OPENCODE_FAMILY, command: 'opencode', provider: 'opencode', displayName: 'OpenCode', tier: 'primary', binary: 'opencode', npmPackage: 'opencode-ai' , modelDiscoveryArgv: ['models'] },
  ...
  { ...OPENCODE_FORK_BASE, command: 'kilo', provider: 'kilo', displayName: 'Kilo Code CLI', tier: 'more', binary: 'kilo', npmPackage: '@kilocode/cli', permissionModes: ['ask', 'auto'], permissionArgv: { ask: { argv: [] }, auto: { argv: ['--auto'] } } , modelDiscoveryArgv: ['models'] },
